  ...
  return (
    <div>
        ...
        <form>
            ...
            <button onClick={addQualification} className="bg-[#0000] py-2 px-5 rounded text-white h-fit cursor-pointer">
                Add Qualification
            </button>
            ...
            <button onClick={addExperience} className="bg-[#0000] py-2 px-5 rounded text-white h-fit cursor-pointer">
                Add Experience
            </button>
         ...
         <div className="mb-5">
                ...
                <button onClick={e=> deleteTimeSlot(e,index)} className="bg-red-600 p-2 rounded-full text-white text-[18px]  mb-[30px]
                cursor-pointer mt-6">
                    <AiOutlineDelete/>
                </button>
            </div>
            ...
            <button onClick={addTimeSlot} className="bg-[#0000] py-2 px-5 rounded text-white h-fit cursor-pointer">
                Add TimeSlot
            </button>
        ...
        { formData.photo && <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor
            ...
            item-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor
...
<div className="mt-7">
    <button type="submit" onClick={updateProfileHandler} className="bg-primaryColor text-white text-
    [18px] leading-[30px] w-full py-3 px-4 rounded-lg">
        Update Profile
        </button>
        </div>
         </form>
